...
def main():
    ...
    parser.add_argument('--num_timesteps', help='', type=int, default=1e6)
    parser.add_argument('--pre_train_timesteps', help='', type=int, default=1e6)
    ...
    parser.add_argument('--demo_path', help='Directory to save learning curve data.', default="../data/expert/human.MontezumaRevengeNoFrameskip-v4.pkl", type=str)
